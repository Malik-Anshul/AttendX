...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username", placeholder="@roy")
    teacher_password = st.text_input("Enter password", type="password", placeholder="Enter your password")

    st.divider()

    cols1, cols2=st.columns(2, vertical_alignment='center')
    with cols1:
        if st.button("Login now", type="secondary", shortcut="control+enter", icon=":material/passkey:", width="stretch"):
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username", placeholder="@roy")
    teacher_name = st.text_input("Enter name", placeholder="roy")
